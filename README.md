...
1. **Clone the repository:**
   ```bash
   git clone [git clone [https://github.com/your-username/skillsphere.git](https://github.com/dhsuzon/assignment_8.git)](https://github.com/dhsuzon/assignment_8.git)
